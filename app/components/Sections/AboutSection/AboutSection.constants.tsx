export const ABOUT_SECTION_TEXT = [
  ...
  "In more recent years I've gone from Recruiter, Business Teacher, LinkedIn sales pro, & author of Talent Bites.",
  ...
  'My qualifications include: BA Business Management & Marketing, PGCE Business & Economics Education, Coaching Accreditation Program certified by the Institute of Training and Occupational Learning (ITOL).',
  'Sales & Career Development is my passion and I can help equip you with the tips and tools for long term success.',
];
